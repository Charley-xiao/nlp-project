...
def train(args):
    ...
    train_dataset, val_dataset, _ = generate_dataset(args.dataset_csv)
...
def main():
    ...
    parser.add_argument("--handcrafted_dim", type=int, default=20, help="Dimension of handcrafted features")
